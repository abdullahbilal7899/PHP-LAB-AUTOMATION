...
$sql = "SELECT * from cpri where cpri_id='$cpri_id'";
...
if(isset($_POST['save'])){
    ...
    $sql = "UPDATE cpri SET cpri_name='$cpri_name',cpri_email='$cpri_email', cpri_password='$cpri_password' where cpri_id='$cpri_id'";
		     ...
		     <div class="xp-breadcrumbbar text-center">
                <h4 class="page-title">CPRI WORKER</h4>  
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Cpri Worker Details</li>
                  </ol>                
            </div>

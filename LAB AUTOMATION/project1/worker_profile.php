...
<div class="text-data">
    <span style="text-transform:none" class="name"><?php echo $data['worker_name'] ?></span>

    <span style="text-transform:none"  class="email"><?php echo $data['worker_email'] ?></span>
    <span style="text-transform:none"  class="email" >Password:<?php echo $data['worker_password'] ?></span>
</div>
...
<div class="buttons">
    ...
    <button class="button"><a  href="edit_workerprofile.php?email=<?php echo $_GET['email']; ?>  "  >Edit Details</a></button>
<button   class="button"><a  href="delete_profile.php?email=<?php echo $_GET['email']; ?>  "  >Delete Account</a></button>
</div>

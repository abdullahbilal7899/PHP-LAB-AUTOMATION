...
$sql = "SELECT * from product where product_status='fail'";
        ...
        <div  class="media align-items-lg-center flex-column flex-lg-row p-3">
          <div class="media-body order-2 order-lg-1">
            ...
            <div class="d-flex align-items-center justify-content-between mt-1">
              <a href="cpritest_prod.php?product_id=<?php echo $arr['product_id']; ?>&email=<?php echo $_GET['email'];?>"><button name="save" class="btn btn-outline-success btn-sm mt-2" type="button">Start Testing</button></a>
             </div>

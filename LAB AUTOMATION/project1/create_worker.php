		     ...
		     <div class="xp-breadcrumbbar text-center">
                <h4 class="page-title">LAB WORKER</h4>  
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Create Lab Worker</li>
                  </ol>                
            </div>
    ...
    <div class="forms">
        <div class="form-content">
          <div class="login-form">
            <div class="title">Create Worker</div>
          <form action="worker_process.php?email=<?php echo $_GET['email']; ?>" method="post" enctype="multipart/form-data">
            <div class="input-boxes">
            <div class="input-box">
                <i class="fas fa-user"></i>
                <input type="text" placeholder="Enter your admin Name"  name="worker_name" required>
              </div>
              <div class="input-box">
                <i class="fas fa-envelope"></i>
                <input type="text" placeholder="Enter your admin email"  name="worker_email" required>
              </div>
              <div class="input-box">
                <i class="fas fa-lock"></i>
                <input type="password" id="password-field" placeholder="Enter your admin password"  name="worker_password" required > <span style="  float: right;margin-left: -25px; margin-top: 15px;position: relative;z-index: 2;font-size:20px;" toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
              </div>

...
if(isset($_POST['save'])){
    ...
    $sql = "UPDATE worker SET worker_name='$worker_name', worker_email='$worker_email', worker_password='$worker_password' where worker_id='$worker_id'";
...
logout</span>Logout</a>
		     ...
		     <div class="xp-breadcrumbbar text-center">
                <h4 class="page-title">LAB WORKER</h4>  
                  ...
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Worker Details</li>
                  </ol>                
            </div>
	...
	<div class="container">
		<div class="img">
			<img src="images/undraw_circuit_sdmr.svg">
		</div>
		<div class="login-content">
			<form action="" method="post" enctype="multipart/form-data">
				<img src="images/avatar.svg">
			
				<h2 class="title">Update Worker Details</h2>
				<br>
				...
				<div class="input-div one">
					...
					<div class="div">
							...
							<input type="text" class="input" name="worker_name" value="<?php echo $data1['worker_name'] ?>" placeholder="Username" required>
					</div>
				 </div>
           		<div class="input-div one">
           		   <div class="i">
           		   ...
           		   <div class="div">
           		   		...
           		   		<input type="email" class="input" name="worker_email" value="<?php echo $data1['worker_email'] ?>" placeholder="Email" required>
           		   </div>
           		</div>
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
           		    	...
           		    	<input type="password" id="password-field" class="input" name="worker_password" value="<?php echo $data1['worker_password'] ?>" placeholder="Password" required   >   <span style="  float: right;margin-left: -25px; margin-top: 20px;position: relative;z-index: 2;font-size:20px;" toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
            	   </div>
            	</div>

    ...
    <div class="table-title">
      <div class="row">
        ...
        <div class="col-sm-6 p-0 d-flex justify-content-lg-end justify-content-center">
          <a href="create_worker.php?email=<?php echo $_GET['email']; ?>" class="btn btn-success" >
...
?>
        ...
        <tr>
          ...
          <td style="text-transform:none"><?php echo $arr['worker_id'];?></td>
          <td style="text-transform:none"><?php echo $arr['worker_name'];?></td>
          <td style="text-transform:none"><?php echo $arr['worker_email'];?></td>
         <td style="text-transform:none"><?php echo $arr['worker_password'];?></td>
          <td>
            <a href="update_worker.php?worker_id=<?php echo $arr['worker_id'];?>&email=<?php echo $_GET['email']  ?>" class="edit" >
			<i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            <a href="delete_worker.php?worker_id=<?php echo $arr['worker_id'];?>&email=<?php echo $_GET['email']  ?>" class="delete" >

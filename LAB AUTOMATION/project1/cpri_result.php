...
$sql = "
SELECT product.product_name,product.revise_product,product.product_image,product.datee,testing.test_id,testing.test_performer,testing.test_performed,testing.remarks,testing.product_id,product.product_status,testing.result FROM product JOIN testing WHERE product.product_id= testing.product_id  AND testing.result='Fail(Return For Remanufacture)' ;
";
...
$sql2 = "
SELECT product.product_name,product.revise_product,product.product_image,product.datee,testing.test_id,testing.test_performer,testing.test_performed,testing.remarks,testing.product_id,product.product_status,testing.result FROM product JOIN testing WHERE product.product_id= testing.product_id  AND testing.result='pass(By CPRI Testing)' ;
";

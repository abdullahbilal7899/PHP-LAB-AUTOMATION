...
$sql2 = "SELECT * from product where product_id='$product_id' AND product_status=''";
...
$data = mysqli_fetch_array($result);
        ...
        <div class="container-body mt-4">
            <div class="row r4">
                <div class="col-md-5 p-0 klo">
                    <form action="worker_pass.php?email=<?php echo $_GET['email']; ?>&product_id=<?php echo $_GET['product_id']; ?>" method="post" enctype="multipart/form-data"  style="align-items:center;" >
                    <ul>
  ...
  <div class="row" style="display:none;">
    ...
    <div class="col-60">
      <input style="margin-left:18px;"  type="text" id="fname" name="test_performer"  placeholder=""  value="<?php echo $data['worker_name']; ?>" >
    </div>
  </div>
  ...
  <div class="row" style="display:none;">
    ...
    <div class="col-60">
      <input style="margin-left:18px;"  type="text" id="fname" name="product_status"  placeholder=""  value=" " >
    </div>
  </div>
        ...
        <div class="footer d-flex flex-column mt-3">
            <div class="row r4">
              ...
              <div class="col-md-2 myt "><input type="submit" class="fail" name="fail" value="Fail (proceed to CPRI)" ></button></div>
            </div>
        </div>
    </div>
